    ...
    <footer className="bg-tertiary text-textFooter text-sm  ">
      <div className="mx-auto  w-full max-w-screen-xl  py-3 pb-2 px-3 xs:px-[1rem] sm:px-[2rem] md:px-[5rem] lg:px-[10rem]">
        <div className="md:grid grid-cols-2  ">
          <div className="mb-6 relative md:bottom-4  flex gap-2 flex-col">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-2">
                {' '}
                {<IconLocation></IconLocation>} {SITE_CONFIG.address}
              </div>
              <div className="flex gap-2">
                {' '}
                {<IconPhone></IconPhone>} {SITE_CONFIG.phone}
              </div>
              <div className="flex gap-2">
                {' '}
                {<IconMail></IconMail>} {SITE_CONFIG.email}
              </div>

              <div className="flex gap-1 xs:mt-2  sm:justify sm:mt-0">
                <a href={SITE_CONFIG.facebookLink} className="  ">
                  <svg
                    className="w-4 h-4"
                    aria-hidden="true"
                ...
                <a href={SITE_CONFIG.instagramLink} className=" ms-5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <a href={SITE_CONFIG.whatsappLink} className=" ms-5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
          ...
          <div className="grid  grid-cols-2  gap-8 sm:gap-6 sm:grid-cols-4 mt-10 ">
            <div>
              <p className="mb-6 text-md  font-semibold   uppercase text-textPrimary ">
                Information
              </p>
